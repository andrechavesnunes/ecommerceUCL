...
public class CategoriaController extends Controller{
	...
	public Result lista(){
		...
		return ok(views.html.categoria.Lista.render("Categoria",categoria));
	}
	...
	public Result Novo(){
		...
		return ok(views.html.categoria.Detalhe.render(formCategoria,new Long(0),"Categoria"));
	}
	public Result detalhes(Long id){
		...
		return ok(views.html.categoria.Detalhe.render(formPreenchido,categoria.id,"Categoria"));
	}
